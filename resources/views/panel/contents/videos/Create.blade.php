...
@section('content')
    ...
    {!! Form::open(['route' => 'new-video', 'method' => 'POST']) !!}
        <div class="row">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Agregar V&iacute;deo</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtTitle" name="txtTitle" placeholder="Información acerca del vídeo" required />
                                </div>  
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtCodigo" name="txtCodigo" placeholder="https://www.youtube.com/watch?v=(CODIGO)" required />
                                </div>  
                            </div>
                        </div>
